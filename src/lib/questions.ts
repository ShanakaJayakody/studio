...
export const DECISION_MAKING_QUESTIONS: Question[] = [
  {
    ...
    questionText: 'Conclusions: For each statement, indicate if it logically follows from the premises.',
    conclusions: [
  ...
  },
  {
    ...
    questionText: 'Which diagram best represents the information?',
    options: [
